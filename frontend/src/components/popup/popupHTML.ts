  ...
  <div class="modal-content">
    ...
    <form id="editForm">
      <div class="form-group">
        ...
        <input type="number" class="form-input" id="editKart" required />
      </div>
      <div class="form-group">
        <label class="form-label">Turn</label>
        <input type="number" class="form-input" id="editTurn" />
      </div>
      <div class="form-group">
        <label class="form-label">Observer</label>
        <input type="text" class="form-input" id="editObserver" required />
      </div>
      <div class="form-group">
        <label class="form-label">Infringement</label>
        <select class="form-select" id="editInfringement" required>
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="editPenalty" required>
          <option value="">Select...</option>
